...
#         internal static BooleanFeature __CreateBoolean(
#             this BasePart basePart,
#             Body target,
#             Body[] toolBodies,
...
#                 BooleanFeature boolean = (BooleanFeature)(Feature)builder.Commit();
#                 return boolean;
#             }
#         }
...
#     public static Point __ToPoint(this Point3d point3d, string name)
#     {
...
#   public static double __Pow(this int number, int power)
#   {
